    ...
    <div class="card">
      <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" id="jumlah" name="jumlah" value="{{old('jumlah')}}"
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" id="no_telpon" name="no_telpon"
                ...
                <div class="form-group">
                  ...
                  <input type="datetime-local" class="block w-full mt-1 text-sm border-gray-600 bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple text-gray-300 focus:shadow-outline-gray form-input" id="tanggal_reservasi" name="tanggal_reservasi" value="{{old('tanggal_lahir')}}"
